            ...
            <div class="container-fluid">
                ...
                <div class="flex-shrink-0 dropdown">
                    <label for="profile2" class="profile-dropdown">
                        ...
                        <span></span>
                        <img src="user_default.png" alt="mdo" width="40" height="40" class="rounded-circle">
    ...
    <section id="whyus" class="whyus">
        <div class="container marketing">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1> 100% </h1>
                    <p>Mindy's online psychologist has an official license from the Indonesian Psychological Association</p>
                </div>
                <div class="col-lg-4">
                    <h1> 80% </h1>
        ...
        <div class="modal-dialog modal-edit">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Oops.. kamu harus login terlebih dahulu sebelum membeli produk kami:)</p>
                </div><br>
                ...
                <div class="col-lg-6">
                    <form action="forms/contact.php" method="post" role="form" class="php-email-form aos-init aos-animate" data-aos="fade-up">
                        ...
                        <div class="text-center">
                            <a href="landingpage_anonymous.html" type="button" class="btn btn-secondary"> Submit </a>
                        </div>
                    </form>
                </div>
            </div>
